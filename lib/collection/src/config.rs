...
use segment::types::{
    Distance, HnswConfig, Indexes, QuantizationConfig, SparseVectorDataConfig,
...
use crate::operations::types::{
    CollectionError, CollectionResult, SparseVectorParams, VectorParams, VectorParamsDiff,
                ...
                .map(|(name, _params)| {
                    (
                        ...
                        SparseVectorDataConfig {
                            storage_type: SparseVectorStorageType::Memory,
                            index: SparseIndexConfig {
                                full_scan_threshold: _params
                                    .index
